...
.cq-wrap{max-width:1080px;margin:0 auto;padding:0 20px 90px}
.cq-nav{display:flex;gap:4px;align-items:center;padding:18px 0 14px;flex-wrap:wrap;border-bottom:1px solid rgba(200,162,75,.22);position:sticky;top:0;z-index:40;
...
.toaststack{position:fixed;bottom:18px;left:50%;transform:translateX(-50%);z-index:90;display:flex;flex-direction:column;gap:8px;align-items:center}
...
@media(max-width:640px){ .cq-wrap{padding:0 12px 80px} .cq-brand small{display:none} .bookcard{padding:12px} }
